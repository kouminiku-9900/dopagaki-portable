...
/* The portrait surface (512x480, dopagaki-portable) fits in the same slot. */
_Static_assert((size_t) PSP_MEDIA_PORTRAIT_FRAME_STRIDE
                   * PSP_MEDIA_PORTRAIT_FRAME_ROWS * 4u
                   <= PSP_MEDIA_POOL_MAX_SURFACE_BYTES,
               "portrait surface exceeds the pool slot");
